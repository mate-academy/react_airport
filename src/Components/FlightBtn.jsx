...
import './FlightBtn.css';

export default class FlightBtn extends Component {
  render() {
    return (
      <>
        <div className="air-table__btn">
          <button className={this.props.display === 'departures' ? ' air-btn--focus btn-left' : 'air-btn--focus-no'}
            onClick={() => this.props.displayChanged('departures')}>
              <span>
          ...
          <button className={this.props.display === 'arrivals' ? ' air-btn--focus btn-right' : 'air-btn--focus-no'}
          onClick={() => this.props.displayChanged('arrivals')}>
          <span>
            <svg className="air-svg" width="40px" height="28px" viewBox="0 0 40 28" version="1.1" xmlns="http://www.w3.org/2000/svg">
