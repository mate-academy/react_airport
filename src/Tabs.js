...
export default function Tabs(props){
  return (
    <div>
      <button type="button" className={props.departures} onClick={props.showDepartures}>
              <span>
                <svg
                  data-v-2cc0fd12=""
                  width="30px"
      ...
      <button className={props.arrivals} type="button" onClick={props.showArrivals}>
              <span>
                <svg
                  data-v-2cc0fd12=""
                  width="30px"
